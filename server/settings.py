...
CELERY_IMPORTS = ("server.cshr.celery.send_email","server.cshr.celery.send_quarter_evaluation_email")
...
REST_FRAMEWORK = {
    ...
    "PAGE_SIZE": 15,  # Hint: if you want to test pagenation try to change it to lower number then test.
}
