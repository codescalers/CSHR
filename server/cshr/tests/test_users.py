...
class GeneralViewUserProfileTests(APITestCase):
    ...
    def setUp(self):
       ...
       admin = User.objects.create(first_name= "Jane", last_name= "Brown",telegram_link= "@janebrown",
        email="jane@gmail.com", birthday= "1998-08-24", mobile_number= "+201234567890",
        location= office,password = make_password("adminpassword"),team= "Development", salary={"gross":2000},
         user_type="Admin", social_insurance_number="086 858 276", image= "profile_image/default.png")
       admin.skills.add(react)
       admin.skills.add(sql)
       Training_Courses.objects.create(user = admin, name= "Meta Back-End Developer", certificate_link= "https://www.coursera.org/account/accomplishments/verify/M683GBLNBAG")
       Training_Courses.objects.create(user = admin, name= "Meta Front-End Developer", certificate_link= "https://www.coursera.org/account/accomplishments/verify/AN9NHYDB990")
       Company_properties.objects.create(name="computer",user=admin)
    #    Evaluations.objects.create(user= admin, link= "https://evaluation1")
       
       user = User.objects.create(first_name= "John", last_name= "Blake",telegram_link= "@johnblake",
        email="john@outlook.com", birthday= "2000-12-30", mobile_number= "+201012345678",
        location= office, password = make_password("userpassword")  ,team= "Development",salary={"gross":2000}, 
        user_type="User", reporting_to= admin, social_insurance_number="046 454 286",
        image= "profile_image/default.png")
       user.skills.add(react)
       user.skills.add(sql)
       Training_Courses.objects.create(user = user, name= "Meta Back-End Developer", certificate_link= "https://www.coursera.org/account/accomplishments/verify/BHGJFT7778")
       Training_Courses.objects.create(user = user, name= "Meta Front-End Developer", certificate_link= "https://www.coursera.org/account/accomplishments/verify/HBHJJ77H3L")
       Company_properties.objects.create(name="computer",user=user)
    #    Evaluations.objects.create(user= user, link= "https://evaluation2")
       
       supervisor = User.objects.create(first_name= "Sarah", last_name= "Poland",telegram_link= "@sarahpoland",
        email="sarah@hotmail.com", birthday= "1996-03-12", mobile_number= "+201123456789",
        location= office, password= make_password("superpassword"), team= "Development",salary={"gross":2000},
        user_type="Supervisor", reporting_to= admin, social_insurance_number="121 212 121",
        image= "profile_image/default.png")
       supervisor.skills.add(react)
       supervisor.skills.add(sql)
       Training_Courses.objects.create(user = supervisor, name= "Meta Back-End Developer", certificate_link= "https://www.coursera.org/account/accomplishments/verify/HGYFT99JI3")
       Training_Courses.objects.create(user = supervisor, name= "Meta Front-End Developer", certificate_link= "https://www.coursera.org/account/accomplishments/verify/KY55GG0OQ1")
    ...
    def test_get_all_users_User(self):
        ...
        self.assertEqual(response.data["data"][1]["image"], '/profile_image/default.png')
        ...
        self.assertEqual(response.data["data"][1]["user_certificates"][0]["name"], "Meta Back-End Developer")
    ...
    def test_get_a_user(self):
       ...
       self.assertEqual(response.data["data"]["image"], 'http://testserver/profile_image/default.png')
       ...
       self.assertEqual(response.data["data"]["user_certificates"][0]["name"], "Meta Back-End Developer")
...
class SupervisorViewUserProfileTests(APITestCase):
    ...
    def test_get_all_users_supervisor(self):
        ...
        self.client.credentials(HTTP_AUTHORIZATION='Bearer ' + self.access_token_supervisor)
        response = self.client.get(url, format="json")
        self.assertEqual(len(response.data["data"]),3)
        self.assertEqual(response.data["data"][1]["full_name"], "John Blake")
        self.assertEqual(response.data["data"][1]["image"], 'http://testserver/profile_image/default.png')
        self.assertEqual(response.data["data"][1]["birthday"], "2000-12-30")
        self.assertEqual(response.data["data"][1]["telegram_link"], "@johnblake")
        self.assertEqual(response.data["data"][1]["email"], "john@outlook.com")
        self.assertEqual(response.data["data"][1]["location"], 1)
        ...
        self.assertEqual(response.data["data"][1]["social_insurance_number"],"046 454 286")
        self.assertEqual(response.data["data"][1]["team"], "Development")
        self.assertEqual(response.data["data"][1]["user_company_properties"][0]["name"],"computer")
    ...
    def test_get_a_user_supervisor(self):
       ...
       self.assertEqual(response.data["data"]["social_insurance_number"],"046 454 286")
       self.assertEqual(response.data["data"]["team"], "Development")
       self.assertEqual(response.data["data"]["user_company_properties"][0]["name"],"computer")
...
class AdminViewUserProfileTests(APITestCase):
    ...
    def test_update_all_fields_of_a_user(self):
        ...
        self.assertEqual(response.data["data"]["social_insurance_number"], "123 456 789")
...
class SelfViewUserProfileTests(APITestCase):
    ...
    def test_get_my_profile(self):
        ...
        self.assertEqual(response.data["data"]["email"], "john@outlook.com")
        self.assertEqual(response.data["data"]["location"], 1)
        self.assertEqual(response.data["data"]["reporting_to"]["email"],'jane@gmail.com')
        self.assertEqual(response.data["data"]["skills"],[1,2])
        self.assertEqual(response.data["data"]["user_certificates"][0]["name"], "Meta Back-End Developer")
        self.assertEqual(response.data["data"]["mobile_number"],"+201012345678")
        self.assertEqual(response.data["data"]["social_insurance_number"],"046 454 286")
    ...
    def test_update_my_profile(self):
        ...
        self.assertEqual(getresponse.data["data"]["image"], 'http://testserver/profile_image/default.png')
        ...
        self.assertEqual(getresponse.data["data"]["reporting_to"]["email"],'jane@gmail.com')
        self.assertEqual(getresponse.data["data"]["skills"],[1,2])
        self.assertEqual(getresponse.data["data"]["user_certificates"][0]["name"], "Meta Back-End Developer")
        self.assertEqual(getresponse.data["data"]["mobile_number"],"+201093129222")
        self.assertEqual(getresponse.data["data"]["social_insurance_number"],"123 456 789")
        self.assertEqual(getresponse.data["data"]["team"], "Development")
        self.assertEqual(getresponse.data["data"]["user_company_properties"][0]["name"],"computer")
