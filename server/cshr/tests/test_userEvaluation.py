...
class UserEvaluationTests(APITestCase):
    ...
    def test_get_all_user_evaluation_by_admin(self):
    ...
    def test_admin_get_user_evaluation_by_id(self):
    ...
    def test_supervisor_get_user_evaluation_by_id(self):
    ...
    def test_user_get_own_user_evaluation_by_id(self):
    ...
    def test_user_get_unauthorized_user_evaluation_by_id(self):
    ...
    def test_unauthenticated_get_user_evaluation_by_id(self):
    ...
    def test_admin_update_user_evaluation(self):
    ...
    def test_supervisor_update_user_evaluation(self):
    ...
    def test_user_update_user_evaluation(self):
    ...
    def test_unauthenticated_update_user_evaluation(self):
    ...
    def test_admin_update_not_exists_user_evaluation(self):
    ...
    def test_supervisor_update_not_exists_user_evaluation(self):
    ...
    def test_user_update_not_exists_user_evaluation(self):
    ...
    def test_unauthenticated_update_not_exists_user_evaluation(self):
    ...
    def test_authorized_update_user_evaluation_bad_request(self):
    ...
    def test_admin_delete_user_evaluation(self):
    ...
    def test_supervisor_delete_user_evaluation(self):
