<script lang="ts">
  ...
  const submit = async () => {
    let isError = false;
    try {
      const response = await authenticationAPI.login(emailValue, passwordValue);
...
>
  <defs>
    <linearGradient id="sw-gradient-0" x1="0" x2="0" y1="1" y2="0">
      <stop stop-color="rgba(8.295, 28.398, 65.624, 1)" offset="0%" />
      <stop stop-color="rgba(7.837, 21.303, 42.856, 1)" offset="100%" />
    </linearGradient>
  </defs>
  ...
  <defs>
    <linearGradient id="sw-gradient-1" x1="0" x2="0" y1="1" y2="0">
      <stop stop-color="rgba(8.937, 10.697, 47.409, 1)" offset="0%" />
      <stop stop-color="rgba(11.167, 16.832, 61.07, 1)" offset="100%" />
    </linearGradient>
  </defs>
