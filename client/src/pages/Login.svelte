...
import { authStore } from "../stores";
  ...
  let formDisable=(isErrormail==null || isErrorpass==null || isErrormail|| isErrorpass) as boolean;
  $:formDisable=(isErrormail==null || isErrorpass==null || isErrormail|| isErrorpass) as boolean;
  let isLoading=false;
...
let myloggingData: loggingData =  await loginDataService.login(emailValue, passwordValue);  
 
authStore.updateTokens(myloggingData.access_token, myloggingData.refresh_token);
...
<div class= "card m-auto">
  <img
  alt="threefold logo" 
  src="/assets/images/threefold-logo.jpeg"> 
  <h3>Sign In</h3>
<fieldset
id="isloading"
disabled={isLoading}
