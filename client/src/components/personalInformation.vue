...
export default {
    ...
    setup(props) {
        ...
        const profileInfoHeaders = ["Full Name", "Email", "Telegram", "Birthday", "Team", "Phone Number", "Social insurance number",
            "Address", "Joining date", "Location"];

        const profileInfodata = ["full_name", "email", "telegram_link", "birthday", "team", "mobile_number", "social_insurance_number",
            "address", "joining_at"];
