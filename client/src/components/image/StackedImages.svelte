    ...
    {#if image.image.includes("profile_image")}
      {#if image.image[0] == "/"}
        ...
        <img 
          ...
          src="{process.env.APP_BASE_API_URL?.slice(0, -1) + image.image}"
      ...
      {:else}
        <div
            ...
            style="background-image:url({process.env.APP_BASE_API_URL + image.image});z-index:${100 - index};border:1.5px solid"
