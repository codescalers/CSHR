...
export async function calendarData(isLoading, month, year, items) {
    removeUnUsedModal();
    isLoading = true;
    try {
...
export function findRowCol(dt, days) {
...
export async function initMonthItems(isLoading, month, year, items, days) {
...
export function initMonth(days, month, year) {
    days = [];
