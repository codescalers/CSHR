export const nameRules = [
  ...
  (v: string) => (v && v.length >= 3 && v.length <= 50) || 'Name must be between 3 and 50 characters.',
];
...
export const mobileRules = [
  ...
  (v: string) => (v && v.toString().length >= 10 && v.toString().length <= 15) || 'Enter a valid mobile number.',
];

export const jobRules = [
  (v: string) => typeof v === 'string' || 'Role must be a string.',
  (v: string) => !!v || 'Role is required.',
  (v: string) => (v && v.length >= 3 && v.length <= 50) || 'Role must be between 3 and 50 characters.',
];

export const addressRules = [
  (v: string) => typeof v === 'string' || 'Address must be a string.',
  (v: string) => !!v || 'Address is required.',
  (v: string) => (v && v.length >= 3 && v.length <= 50) || 'Address must be between 3 and 50 characters.',
];
export const socialInsuranceRules = [
  ...
  (v: string) => (v && v.length >= 3 && v.length <= 50) || 'Social Number must be between 3 and 50 characters.',
];
