...
{#if isLoading}
    <div class="bg-white p-3 card d-flex justify-content-center align-items-center">
        <Loading className={"loader mt-2"}/>
        <span class="mt-3">Loading Balance...</span>
    </div>
{:else}
    <div class="bg-white p-3 pt-0 mt-0 card">
        <div class="card-body">
            <div class="text-center">
                <small>The displayed values reflect the current year's data for the respective office. If you wish to generate new values, please change the year. Otherwise, the existing data for <strong>{year}</strong> will be modified.</small>
            </div>
